...
3. Format (สำคัญมาก — ต้องปฏิบัติตามอย่างเคร่งครัด):
   * เขียนเป็น **ความเรียง (Paragraph) ล้วนๆ บอกแค่เนื้อหาอย่างเดียว**
   * ห้ามมีหัวข้อย่อย ห้ามแบ่งเป็นข้อๆ ห้ามใช้ bullet points ห้ามใช้ตัวเลขนำหน้า
   * ห้ามขึ้นต้นด้วย "สาระสำคัญ:", "หน่วยนี้:", "ในหน่วยนี้", "ผู้เรียนจะ" หรือคำนำใดๆ
   * ห้ามแยกเป็น "ความรู้:", "ทักษะ:", "เจตคติ:", "ด้านความรู้", "ด้านทักษะ" ฯลฯ
   * ห้ามใช้คำว่า "สามารถ", "ได้แก่", "ประกอบด้วย" ในการแจกแจงรายการ
   * ให้เขียนต่อเนื่องเป็นย่อหน้าเดียว อ่านลื่นไหล บอกเนื้อหาที่จะเรียนตรงๆ เหมือนเขียนอธิบายให้คนอ่านเข้าใจว่าหน่วยนี้เรียนอะไร
   * ความยาวประมาณ 3-5 บรรทัด ต่อหน่วย
