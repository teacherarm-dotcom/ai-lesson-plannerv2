...
function configuredParser() {
  var _config$normalizeQuot, _config$handleDotThis;
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  (_config$normalizeQuot = config.normalizeQuotes) !== null && _config$normalizeQuot !== void 0 ? _config$normalizeQuot : config.normalizeQuotes = true;
  (_config$handleDotThis = config.handleDotThis) !== null && _config$handleDotThis !== void 0 ? _config$handleDotThis : config.handleDotThis = true;
  var lastResult = null;
  return function parser(tag, meta) {
    var _lastBody$expression;
    ...
    var isAssignment = (lastBody === null || lastBody === void 0 || (_lastBody$expression = lastBody.expression) === null || _lastBody$expression === void 0 ? void 0 : _lastBody$expression.type) === "AssignmentExpression";
