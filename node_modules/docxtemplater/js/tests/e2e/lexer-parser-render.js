...
function normalizeFixture(fixture) {
  if (fixture.contentText) {
    if (fixture.content) {
      throw new Error("invalid fixture : content and contentText cannot both be set");
    }
  ...
  if (fixture.contentParagraph) {
    if (fixture.content) {
      throw new Error("invalid fixture : content and contentParagraph cannot both be set");
    }
...
describe("Algorithm", function () {
  var _loop = function _loop() {
    var _fixture$async, _fixture$sync;
    ...
    if ((_fixture$async = fixture.async) !== null && _fixture$async !== void 0 ? _fixture$async : true) {
    ...
    if ((_fixture$sync = fixture.sync) !== null && _fixture$sync !== void 0 ? _fixture$sync : true) {
